...
async def scrape_tweet(url: str) -> Dict:
    ...
    try:
        ...
        log.error("Error occurred while scraping tweet {}: {}", url, str(e))
        return "ERROR: Unable to scrape tweet."
...
async def scrape_profile(url: str) -> Dict:
    ...
    try:
        ...
        log.error("Error occurred while scraping profile {}: {}", url, str(e))
        return "ERROR: Unable to scrape profile."
